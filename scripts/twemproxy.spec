Summary: Twitter's twemproxy redis and memcached proxy
Name: twemproxy
Version: 0.2.2
Release: 1
...
%description
twemproxy (pronounced "two-em-proxy"), aka twemproxy is a fast and lightweight proxy for memcached and redis protocol.
